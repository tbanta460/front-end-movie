    ...
    return (
        <>  <div className="relative rouded-md m-5" onMouseEnter={showInfo} onMouseOut={hideInfo}>
            {update ? <InfoMovie data={props.data}/> : ""}
                <div className="" >
                    <Image className="object-cover relative rounded-md w-40 h-60 inline-block transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 cursor-pointer" src={props.data.img}/> 
                </div>
            </div>
        </>
    )
